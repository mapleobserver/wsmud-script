...
[if] (onlyss) != null
    ...
    [if] (yesno) = 1 || (yesno) = 3 || (yesno) = 6 || (yesno) = 7 || (yesno) = 9
        ...
        [else if] (num) = 28
            chat (name)数着背包里的玄晶，脸上露出欣慰的笑容。
        [else if] (num) = 29
            chat 啊，是(name)大佬，我死了。
        [else if] (num) = 30
            chat (name)自从用了白驼山壮骨粉，腰不疼腿不酸，上华山绝顶都有劲，就是偶尔会学蛤蟆叫。
        [else if] (num) = 31
        ...
        [else if] (num) = 39
            chat (name)左手抱着王语嫣，右手揽着程灵素，背后还有个小昭捏肩捶背。
        [else if] (num) = 40
            chat (name)你已经是个成熟的矿工了，应该学会自己打副本。